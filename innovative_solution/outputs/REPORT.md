...
![外层误差](branch_selection/plots/review_nested_mse.png)

![八候选选择](branch_selection/plots/supplement_selection.png)

![算法预算比较](branch_selection/plots/fair_algorithms.png)

![尾段区间](branch_selection/plots/review_tail_interval.png)

![逐样本残差](branch_selection/plots/review_tail_residuals.png)

![条件覆盖](branch_selection/plots/supplement_coverage.png)